...
button.addEventListener("click", () => {
  ...
  if (validateEmptyInput(userName)) return; // Caso o retorno da função criada acima seja realmente verdadeiro, este return serve para impedir que o código continue rodando e a função getUserData abaixo seja chamada mesmo assim
...
async function getUserData(userName) {
  ...
  if (userResponse.message === "Not Found") {
    // Verifica se o usuário foi encontrado. Se não, dispara a função renderNotFound, criada no objeto screen do arquivo "objects/screen.js"
