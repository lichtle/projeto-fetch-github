...
async function getUserData(userName) {
  ...
  if (userResponse.message === "Not Found") { // Verifica se o usuário foi encontrado. Se não, a promise retornará um objeto com chave message e valor "Not Found" e irá disparar a função renderNotFound, criada no objeto screen do arquivo "objects/screen.js"
